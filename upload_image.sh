...
scp $key_args $BOX sites@orval.galaxyproject.org:$REMOTE_ROOT/rstudio/$NAME
ssh $key_args sites@orval.galaxyproject.org bash -c "cd $REMOTE_ROOT/rstudio && ln -f -s $NAME latest.box"
